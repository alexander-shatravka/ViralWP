...
if( empty( $options->current ) || null === $options->current ) {
    ...
    <table cellspacing="0" id="wpstg-external-db">
        <tbody>
            ...
            <tr>
                <th>User</th><td><input readonly type="text" name="wpstg_db_username" id="wpstg_db_username" value="" autocapitalize="off" class="">
                </td></tr>
            <tr>
                <th>Password</th><td><input readonly type="password" name="wpstg_db_password" id="wpstg_db_password" class="">
                </td></tr>
            <tr>
                <th>Database</th><td><input readonly type="text" name="wpstg_db_database" id="wpstg_db_database" value="" autocapitalize="off">
                </td></tr>
            <tr>
                <th>Database Prefix</th><td><input readonly type="text" name="wpstg_db_prefix" id="wpstg_db_prefix" value="<?php echo $db->prefix; ?>" placeholder="<?php echo $db->prefix; ?>" autocapitalize="off">
                </td></tr>
            <tr>
                <th></th>
                <td><a href="#" id="wpstg-db-connect">Test Database Connection</a></td>
            </tr>
        </tbody>
    </table>
