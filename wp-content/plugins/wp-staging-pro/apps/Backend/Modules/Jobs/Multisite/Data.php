...
//      }
    ...
    protected function step18() {
        ...
        $this->log( "Preparing Data Step18: Remove UPLOADS in wp-config.php" );
        ...
        if( !empty( $matches[0] ) ) {
            ...
            $this->log( "Preparing Data Step18: UPLOADS not defined in wp-config.php. Skipping this step." );
        }
        ...
        $this->Log( "Preparing Data Step 18: Finished successfully" );
        return true;
    }
...
//            $this->log( "Preparing Data Step19: Failed to create robots.txt", Logger::TYPE_ERROR );
//        }
//        return true;
//    }
