...
//      }
    ...
    protected function step19() {
        ...
        $this->log( "Preparing Data Step19: Remove UPLOADS in wp-config.php" );

        if( false === ($content = file_get_contents( $path )) ) {
            $this->log( "Preparing Data Step19: Failed to get UPLOADS in wp-config.php. Can't read wp-config.php", Logger::TYPE_ERROR );
            return false;
        }
        ...
        if( false === @file_put_contents( $path, $content ) ) {
            $this->log( "Preparing Data Step19: Failed to update UPLOADS. Can't save contents", Logger::TYPE_ERROR );
            return false;
        }
