...
//   }
    ...
    public function jobDatabase() {
        ...
        // but for xdebug purposes its better to have separate if blocks
        if( is_multisite() ) {
            // Is Multisite
    ...
    public function jobDirectories() {
        ...
        //return $this->handleJobResponse( $directories->start(), "FileArchive" );
    }
     ...
     * @return object
     */
//   public function jobFileArchive(){
//      $fileArchive = new FileArchive();
//      return $this->handleJobResponse( $fileArchive->start(), "finish" );
//   }
