...
class SystemInfo extends InjectionAware {
    ...
    public function wpstaging() {
        ...
        $output .= $this->info( "Plugin Version:", get_option( 'wpstgpro_version', 'undefined' ) );
        $output .= $this->info( "Install Date:", get_option( 'wpstg_installDate', 'undefined' ) );
        $output .= $this->info( "Upgraded from:", get_option( 'wpstgpro_version_upgraded_from', 'undefined' ) );
